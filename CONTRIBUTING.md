# Contributing to Credit-approval-model

First off, thank you for taking the time to contribute! It is people like you who make this project such an amazing tool.
...
2. **Clone** your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/Credit-approval-model.git
   ```
...
- If you import new external libraries, make sure to add them to `requirements.txt`.
- Test the application locally using `streamlit run <entrypoint_file>.py` before submitting your PR.
...
1. Push your changes to your feature branch on your fork:
   ...
   ```
2. Open a **Pull Request (PR)** against our `main` branch (or `master` branch).
